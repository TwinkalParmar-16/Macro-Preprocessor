...
for i in range(len(input_file)):
    ...
    if "MACRO->" in input_file[i]:#if find
        ...
        str1=str1+'['
        str1=str1+str
        str1=str1+']'#str2 stores the first line of the macro(temporary)
...
for i in range(0,len(NAME_TAB),3):#gap=3 bcz next two index contains the addresses 
    ...
    temp_str=temp_str+']'#stores the name of the macro ,whoes arguments are going to be stored(temporary)
